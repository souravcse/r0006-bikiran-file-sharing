...
function UserDriveDevApiPrivatePage({ reloadId, setReloadId }) {
    ...
    const handleGetCode = (e) => {
        AxiosAuth.get(`${ConfigApi.API_PRIVATE_CODE.replace(':apiSl', e)}`).then((response) => {
    ...
    useEffect(() => {
        AxiosAuth.get(`${ConfigApi.API_PRIVATE_LIST}`).then((response) => {
    ...
    return (
        <>
            <MyDriveTitleDev title="Drive Develop Private Api" />
...
export default UserDriveDevApiPrivatePage;
